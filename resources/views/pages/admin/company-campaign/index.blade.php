<x-layouts.admin-layout>
            ...
            <div class="page-header-content d-lg-flex">
                <div class="d-flex">
                    <h4 class="mb-0 page-title">
                        Phân công công ty thực tập - <span class="fw-normal">Danh sách đợt đăng ký</span>
                    </h4>
            ...
            <div class="page-header-content d-lg-flex border-top">
                <div class="d-flex">
                    <div class="py-2 breadcrumb">
                        ...
                        <a href="" class="breadcrumb-item">Phân công công ty thực tập</a>
    ...
    <div class="content">
        <livewire:admin.company-campaign.company-campaign-index />
    </div>
</x-layouts.admin-layout>

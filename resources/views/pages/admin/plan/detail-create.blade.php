...
{{--    <x-slot name="custom_js">--}}
            ...
            <div class="page-header-content d-lg-flex">
                <div class="d-flex">
                    <h4 class="mb-0 page-title">
                        Kế hoạch chi tiết - <span class="fw-normal">Tạo mới</span>
                    </h4>
            ...
            <div class="page-header-content d-lg-flex border-top">
                <div class="d-flex">
                    <div class="py-2 breadcrumb">
                        ...
                        <a href="{{ route('admin.plans.show', $id) }}" class="breadcrumb-item">Mẫu kế hoạch</a>
    ...
    <div class="content">
        <livewire:admin.plan.plan-detail-create :planId="$id" />
    </div>
